...
internal class AuthRepository(
    @Named("local") @Provided private val localUserFormStore: SignInUpFormStore,
    @Provided private val firebaseAuth: FirebaseAuth,
) : AuthRepo {
    override suspend fun createUser(): Result<UserModel> =
        kotlin.runCatching { localUserFormStore.signUpDataFlow.first() }
    ...
    override suspend fun signIn(): Result<UserModel> =
        kotlin.runCatching { localUserFormStore.signInDataFlow.first() }
